            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateElement(selectedElement.id, { brightness: parseInt(e.target.value) })
                  }
                  className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-primary"
                />
              </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateElement(selectedElement.id, { strokeWidth: parseFloat(e.target.value) })
                }
                className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-primary"
              />
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              >
                <optgroup label="Sans Serif">
                  ...
                  <option value="Trebuchet MS, sans-serif" style={{ fontFamily: 'Trebuchet MS' }}>
                    Trebuchet MS
                  </option>
                </optgroup>
                ...
                <optgroup label="Display">
                  ...
                  <option value="Comic Sans MS, cursive" style={{ fontFamily: 'Comic Sans MS' }}>
                    Comic Sans MS
                  </option>
                ...
                <optgroup label="Monospace">
                  ...
                  <option value="Courier New, monospace" style={{ fontFamily: 'Courier New' }}>
                    Courier New
                  </option>
                  <option
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-xs text-gray-500">{selectedElement.lineHeight ?? 1.2}</span>
              </div>
              <input
                type="range"
                min="0.8"

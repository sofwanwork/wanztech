        ...
        <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 mt-2 text-sm md:text-base">Manage your forms, analyze responses, and share with the world.</p>
                </div>
                {/* Action Buttons */}
                    ...
                    <div className="col-span-full flex flex-col items-center justify-center py-24 border-2 border-dashed border-gray-200 rounded-2xl bg-gray-50/50">
                        {query ? (
                            ...
                            <>
                                ...
                                <p className="text-gray-500 mb-8 text-center text-sm max-w-sm">
                                    Start by creating your first form. It only takes a few seconds to get up and running.
                                </p>
                                <form
                                    action={async () => {
                                        "use server";
                    ...
                    >
                        ...
                        <div className="relative w-full aspect-[4/3] bg-gray-50 overflow-hidden">
                            ...
                            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center gap-3 backdrop-blur-[2px]">
                                <Link href={`/builder/${form.id}`}>
                                    <Button size="sm" variant="secondary" className="font-medium min-w-[100px] shadow-lg hover:bg-white transition-colors">
                                        Edit Form
                                    </Button>
                                </Link>
                            </div>
                        ...
                        <CardHeader className="p-5 pb-3">
                            <div className="flex justify-between items-start gap-2">
                                <CardTitle className="truncate text-lg font-semibold text-gray-900 leading-tight">{form.title}</CardTitle>
                        ...
                        <CardFooter className="p-5 pt-3 border-t border-gray-50 flex items-center justify-between">
                            ...
                            <Link href={form.shortCode ? `/s/${form.shortCode}` : `/form/${form.id}`} target="_blank">
                                <Button size="sm" variant="outline" className="h-8 text-primary border-primary/20 hover:bg-primary/5 hover:text-primary gap-1.5 rounded-full px-4 transition-all hover:pr-5">
